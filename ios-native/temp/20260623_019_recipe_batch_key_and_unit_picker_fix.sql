...
set preparation_note = ''
where preparation_note is null;

alter table public.recipe_ingredients
  alter column preparation_note set default '',
  alter column preparation_note set not null;
...
alter table public.recipe_tasks
  alter column batch_key set default '',
...
revoke all
on function public.save_recipe_full(uuid, jsonb, jsonb, jsonb, jsonb)
from public;
